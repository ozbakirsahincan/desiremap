  ...
  return (
    <section className="relative py-12 sm:py-16 md:py-24 overflow-hidden">
      <div className="absolute inset-0">
        {/* <img src="https://images.unsplash.com/photo-1519167758481-83f550bb49b3?w=1920&q=80" alt="" className="w-full h-full object-cover opacity-20" /> */}
          ...
          {categories.map((category, index) => (
            <motion.a key={category.id} href="#" initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: index * 0.1, duration: 0.5 }} whileHover={{ y: -8 }} className="group relative">
              <div className="relative p-4 sm:p-6 md:p-8 rounded-2xl sm:rounded-3xl bg-linear-to-b from-white/10 to-white/5 border border-white/10 hover:border-[#8b1a4a]/50 backdrop-blur-sm transition-all duration-500 overflow-hidden">
                <div className="relative w-10 h-10 sm:w-12 sm:h-12 md:w-16 md:h-16 mx-auto mb-3 sm:mb-4 md:mb-6 rounded-xl sm:rounded-2xl bg-linear-to-br from-[#8b1a4a]/30 to-[#6b3fa0]/30 flex items-center justify-center"><span className="relative text-[#b76e79] group-hover:text-white transition-colors duration-300">{category.icon}</span></div>
                ...
                <p className="relative text-gray-400 text-xs sm:text-sm group-hover:text-gray-300 transition-colors duration-300">{category.count} Betriebe</p>
